...
import common.xml.dp.DpInf12036Request;
import common.xml.dp.DpInf12036Response;
...
public class INF12036 {
	
	public static String svcInfName = "INF12036";
	...
	public static String execute(String in0, String in1) {
		...
		//本接口的字段信息包含公共信息
		DpInf12036Request dpRequest = null;
		
		//用于封装返回的xml报文
		DpInf12036Response resp = null;
		...
		try {
			...
			//一系列的验证和接口参数的设置
			dpRequest = new DpInf12036Request(in1);
			...
			if (Long.valueOf(resultCode) == 0) {
				...
				seatNum = (String) ds.getParamByID("6900", "690").get(0);
	...
	private static PackageDataSet sag0001(DpInf12036Request dpRequest,
		...
		g682.put("6821", "查询ID");// 
		g682.put("6822", "01");// 
		g682.put("6823", dpRequest.getQueryId());// 
