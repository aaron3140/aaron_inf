...
import common.xml.dp.DpInf06206Request;
import common.xml.dp.DpInf06206Response;
...
/**
 * @author 2014年1月16日 上午9:18:54<br>
 * 
 *         本来描述：[东莞公交]开卡冲正接口
 */
public class INF06206 {
	private static final Log logger = LogFactory.getLog(INF06206.class);

	public static String svcInfName = "INF06206";

	public static String execute(String in0, String in1) {
		DpInf06206Request dpRequest = null;

		DpInf06206Response resp = new DpInf06206Response();
		...
		try {
			...
			dpRequest = new DpInf06206Request(in1);
	 ...
	 * @throws Exception
	 */
	private static PackageDataSet scs0102reverse(DpInf06206Request dpRequest) throws Exception {
