...
import common.xml.dp.DpCardWithPwdRequest;
import common.xml.dp.DpCardWithPwdResponse;
 ...
 *  有密卡信息查询接口
 */
public class SVC_100005 {

	 public static String svcInfName = "100005";
	...
	public static String execute(String in0, String in1) {
		Long pk = null;
		DpCardWithPwdRequest cardWithPwdRequest = null;
		String cardNo = null;
		String cardPwd = null;
		String agentCode = null;
		String cardType = null;
		String keep = null;
		DpCardWithPwdResponse resp = null;
		INFLogID logId = new INFLogID(svcInfName,TInfDcoperlogDao.PARTY_GROUP_AG);
		try{
			cardWithPwdRequest = new DpCardWithPwdRequest(in1);
			
			cardNo = cardWithPwdRequest.getCardNo();
			cardPwd = cardWithPwdRequest.getCardPwd();
			agentCode = cardWithPwdRequest.getAgentCode();
			cardType = cardWithPwdRequest.getCardType();
			keep = cardWithPwdRequest.getKeep();
...
//			调用PCM0006
			...
			String reCardType = packageDataSet.getByID("1564", "153");//卡类型
			...
			resp = new DpCardWithPwdResponse();
			...
			return resp.toXMLStr("SUCCESS", keep,svcInfName, responseCode, responseContent, 
					cardSeq, reCardType, cardAmtRe, returnCardNo, balance, availBalance, expDate,
