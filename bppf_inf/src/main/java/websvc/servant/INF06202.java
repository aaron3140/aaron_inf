...
import common.xml.dp.DpInf06202Request;
import common.xml.dp.DpInf06202Response;
...
public class INF06202 {
	private static final Log logger = LogFactory.getLog(INF06202.class);

	public static String svcInfName = "INF06202";
	...
	public static String execute(String in0, String in1) {
		DpInf06202Request dpRequest = null;

		DpInf06202Response resp = new DpInf06202Response();
		...
		try {
			...
			dpRequest = new DpInf06202Request(in1);
...
//			}
			...
			return resp.toXMLStr(respInfo.getReqWebsvrCode(), respInfo.getRespType(), respInfo.getKeep(), "SUCCESS", responseCode, responseDesc, 
					map,dpRequest.getTmnNumNo(),dpRequest.getRemark1(), dpRequest.getRemark2());
	...
	private static Map<String, String> parserXml(String detailContent) throws Exception {
		...
		String[] keys = { "SAMID","POSID", "EDCARDID", "SETTDATE", "BATCHNO", "TOTALSVNUM", "TOTALSVAMT", "TOTALSALEDEP" };
	 ...
	 * @throws Exception
	 */
	private static PackageDataSet sag0002(DpInf06202Request dpRequest)
	throws Exception {
		...
		g682.put("6823", "<PARAMS>" +
				                    ...
				                    "<SETTDATE>"+dpRequest.getSettDate()+"</SETTDATE>" +
				                    "<BATCHNO>"+dpRequest.getBatchNo()+"</BATCHNO>" +
				                    "<TOTALSVNUM>"+dpRequest.getTotalSvnum()+"</TOTALSVNUM>" +
				                    "<TOTALSVAMT>"+dpRequest.getTotalSvamt()+"</TOTALSVAMT>" +
				                    "<TOTALSALEDEP>"+dpRequest.getTotalSaledep()+"</TOTALSALEDEP>" +
				                    "</PARAMS>");
		g682.endRow();
