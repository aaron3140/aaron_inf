...
public class HttpPostDispatcher {
	...
	public static String PKG_NAME = HttpPostDispatcher.class.getPackage().getName();

	public static String CLASS_NAME = "DealProcessorPostSvc";
	
	private static final Log log = LogFactory.getLog(HttpPostDispatcher.class);
