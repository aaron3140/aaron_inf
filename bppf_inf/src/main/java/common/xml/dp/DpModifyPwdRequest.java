 ...
 *
 */
public class DpModifyPwdRequest extends CommonReqAbs {

	public DpModifyPwdRequest(String xmlStr) throws Exception {
	...
	public void setParameters(Document doc, Object reserved) throws Exception {
		...
		oldPasswd = getNodeTextM(doc, "OLDPASSWD");
		newPasswd = getNodeTextM(doc, "NEWPASSWD");
