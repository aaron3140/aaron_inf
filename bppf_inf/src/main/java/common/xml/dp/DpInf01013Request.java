 ...
 */
public class DpInf01013Request extends CommonReqAbs {
	public DpInf01013Request(String xmlStr) throws Exception {
		super(xmlStr, null);
	}
	...
	@CheckerAnnotion(len = 17, type = CheckerAnnotion.TYPE_STR)
