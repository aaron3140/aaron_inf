...
/**
 * @title DpInf02045Response.java
 * @description 理财开户接口回复类
 * @date 2014-02-07 14:37
 * @author lichunan
 * @version 1.0
 */
public class DpInf02045Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_2 = "FUNDCODE";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE,
			...
			String RESPONSECONTENT, String CUSTCODE, String FUNDCODE,
		...
		dataSet.addElement(TAG_NAME_14_2).addText(FUNDCODE);
