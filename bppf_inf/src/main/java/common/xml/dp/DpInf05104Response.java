...
public class DpInf05104Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_15 = "ORDERNO";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE, String RESPONSECONTENT,
			String ORDERNO, String REMARK1, String REMARK2) {
		...
		dataSet.addElement(TAG_NAME_15).addText(ORDERNO);
