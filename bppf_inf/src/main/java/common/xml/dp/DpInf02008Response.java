...
public class DpInf02008Response extends CommonRespAbs {
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE ,
			String RESPONSECONTENT,String REMARK1,String REMARK2) {
		...
		root.addElement(TAG_NAME_14).addText(REMARK1);
		root.addElement(TAG_NAME_15).addText(REMARK2);
