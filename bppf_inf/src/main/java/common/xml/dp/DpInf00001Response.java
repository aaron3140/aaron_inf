...
public class DpInf00001Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_1 = "TRANSEQ";

//	private static final String TAG_NAME_14_2 = "BATCHCODE";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, 
			String RESPONSECODE, String RESPONSECONTENT, String TRANSEQ, String CUSTCODE,String REMARK1,String REMARK2) {
		...
		dataSet.addElement(TAG_NAME_14_1).addText(TRANSEQ);
		
//		dataSet.addElement(TAG_NAME_14_2).addText(BATCHCODE);
		
		dataSet.addElement(TAG_NAME_14_3).addText(CUSTCODE);
