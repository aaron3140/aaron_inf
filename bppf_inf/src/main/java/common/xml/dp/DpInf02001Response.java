...
public class DpInf02001Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_3_1 = "ORDERITEM";
	
	private static final String [] ORDER_ATTR={"ORDERSEQ","TRANSSEQ","CUSTCODE","CUSTNAME","ORDERTYPECODE","ORDERTYPENAME","AREANAME","TMNNUM","ORDERTIME","MEMO","ORDERSTAT","ORDERAMOUNT","PAYSTAT","BUSICODE","BUSINAME","KEEP","OPERCODE","OPERDESC"};
