...
public class DpInf02044Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_1 = "FACEAMOUNT";
	private static final String TAG_NAME_14_2 = "PREMIUM";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE, String RESPONSECONTENT,
			String FACEAMOUNT, String PREMIUM, String REMARK1, String REMARK2) {
		...
		dataSet.addElement(TAG_NAME_14_1).addText(FACEAMOUNT);
		dataSet.addElement(TAG_NAME_14_2).addText(PREMIUM);
