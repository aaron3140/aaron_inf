...
//
public class DpInf02021Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_3 = "PHONE";

	private static final String TAG_NAME_14_4 = "RECHARGEFLOW";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE,
			...
			String PHONE, String RECHARGEFLOW, String TXNAMOUNT,
		...
		resultData.addElement(TAG_NAME_14_3).addText(PHONE);
		resultData.addElement(TAG_NAME_14_4).addText(RECHARGEFLOW);
