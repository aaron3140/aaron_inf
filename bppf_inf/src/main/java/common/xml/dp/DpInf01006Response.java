...
public class DpInf01006Response extends CommonRespAbs {
	...
	private static final String[] ORDER_ATTR = { "ORDERSEQ", "TRANSSEQ", "CUSTCODE", "CUSTNAME", "ORDERTYPECODE", "ORDERTYPENAME", "AREANAME", "TMNNUM", "ORDERTIME", "MEMO",
			"ORDERSTAT", "ORDERAMOUNT", "PAYSTAT", "BUSICODE", "BUSINAME", "BUSIOBJ", "PRODCODE" ,"KEEP"};

	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE, String RESPONSECONTENT, String STARTDATE, String ENDDATE,
