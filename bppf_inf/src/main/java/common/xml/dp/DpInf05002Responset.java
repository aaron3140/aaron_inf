...
public class DpInf05002Responset extends CommonRespAbs{
	...
	private static final String TAG_NAME_14_11="RESPONSEXML";
	
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE,String KEEP, String RESULT, 
			String RESPONSECODE, String RESPONSECONTENT,String RESPONSEXML) {
		...
		dataSet.addElement(TAG_NAME_14_11).addText(RESPONSEXML);
		return doc.asXML();
	}
