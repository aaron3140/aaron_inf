 ...
 */
public class DpInf01014Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_16 = "BANKACCT";
	
	private static final String TAG_NAME_17 = "BUSITYPE";
	
	private static final String TAG_NAME_18 = "TXNAMOUNT";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE ,
			String RESPONSECONTENT,String ORDERSEQ,String CUSTCODE,String BANKACCT,String BUSITYPE
			,String TXNAMOUNT,String TRANSSEQ,String REMARK1,String REMARK2) {
		...
		root.addElement(TAG_NAME_16).addText(BANKACCT);
		root.addElement(TAG_NAME_17).addText(BUSITYPE);
		root.addElement(TAG_NAME_18).addText(TXNAMOUNT);
