...
public class DpInf02009Response extends CommonRespAbs{
	...
	private static final String TAG_NAME_14_2 = "PERAMOUNT";
	
	private static final String TAG_NAME_14_3 = "ALLAMOUNT";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE ,
			String RESPONSECONTENT,String ORDERNO,String PERAMOUNT,String ALLAMOUNT,String REMARK1,String REMARK2) {
		...
		resultData.addElement(TAG_NAME_14_2).addText(PERAMOUNT);
		resultData.addElement(TAG_NAME_14_3).addText(ALLAMOUNT);
