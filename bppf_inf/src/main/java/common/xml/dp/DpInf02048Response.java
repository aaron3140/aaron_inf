...
/**
 * @title DpInf02048Response.java
 * @description 理财赎回接口回复类
 * @date 2014-02-11 09:35
 * @author lichunan
 * @version 1.0
 */
public class DpInf02048Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_3 = "RANSOMTYPE";
	private static final String TAG_NAME_14_4 = "TOTALAMOUNT";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE,
			...
			String RANSOMTYPE, String TOTALAMOUNT, String TRADETIME, String REMARK1, String REMARK2) {
		...
		dataSet.addElement(TAG_NAME_14_3).addText(RANSOMTYPE);
		dataSet.addElement(TAG_NAME_14_4).addText(TOTALAMOUNT);
