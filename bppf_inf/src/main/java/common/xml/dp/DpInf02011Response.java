...
public class DpInf02011Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_20 = "PAYAMOUNT";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE, String RESPONSECONTENT,
			String ORDERSEQ, String REMARK1, String REMARK2, String TRANSSEQ, String TXNAMOUNT,String PAYAMOUNT) {
		...
		if(PAYAMOUNT !=null){
			dataSet.addElement(TAG_NAME_20).addText(PAYAMOUNT);
		}
