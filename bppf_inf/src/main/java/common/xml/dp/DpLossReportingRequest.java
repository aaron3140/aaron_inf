 ...
 *
 */
public class DpLossReportingRequest extends CommonReqAbs {

	public DpLossReportingRequest(String xmlStr) throws Exception {
	...
	@CheckerAnnotion(len = 2, type = CheckerAnnotion.TYPE_STR)
	private String repLossWay;
	
	@CheckerAnnotion(len = 2, type = CheckerAnnotion.TYPE_STR)
	private String repLossType;
	...
	public void setParameters(Document doc, Object reserved) throws Exception {
		...
		repLossWay = getNodeTextM(doc, "REPLOSSWAY");
		repLossType = getNodeTextM(doc, "REPLOSSTYPE");
	...
	public String getRepLossType() {
		return repLossType;
	}


	public void setRepLossType(String repLossType) {
		this.repLossType = repLossType;
	}


	public String getRepLossWay() {
		return repLossWay;
	}


	public void setRepLossWay(String repLossWay) {
		this.repLossWay = repLossWay;
	}
