...
public class DpInf02033Response extends CommonRespAbs {
	...
	private static final String TAG_NAME_14_2 = "TXNAMOUNT";
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE,
			...
			String RESPONSECONTENT, String SYSTEMNO, String TXNAMOUNT,
		...
		dataSet.addElement(TAG_NAME_14_2).addText(TXNAMOUNT);
