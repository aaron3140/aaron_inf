...
/**
 * @title DpInf02047Request.java
 * @description 理财申购支付接口请求类
 * @date 2014-02-11 09:29
 * @author lichunan
 * @version 1.0
 */
public class DpInf02047Request extends CommonReqAbs {

	public DpInf02047Request(String xmlStr) throws Exception {
		super(xmlStr, null);
	...
	public void setParameters(Document doc, Object reserved) throws Exception {
		...
		businessOrderNo = getNodeTextM(doc, "BUSINESSORDERNO");
		passWord = getNodeTextM(doc, "PASSWORD");
		totalAmount = getNodeTextM(doc, "TOTALAMOUNT");
		fundSourceType = getNodeTextM(doc, "FUNDSOURCETYPE");
