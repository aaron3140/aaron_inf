...
public class DpInf03002Response extends CommonRespAbs {
	...
	public String toXMLStr(String REQWEBSVRCODE, String RESPONSETYPE, String KEEP, String RESULT, String RESPONSECODE ,
		...
		datas.addElement(TAG_NAME_14_4_1).addText(ValueUtil.s(RANDNUM));
