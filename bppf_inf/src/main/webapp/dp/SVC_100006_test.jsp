...
<html>
	...
	<body>
		...
		<form name="cardBalance" method="post"
			action="${sessionScope.path}/httppost">
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="100006">
			<input type="hidden" name="method" value="cardBalance">
			<table>
			<tr>
					<td><font color="red" size="5">卡余额查询接口</font></td>
				</tr>
				<tr>
					<td>
						AGENTCODE：
