...
<html>
	...
	<body>
		...
		<form name="queryCardWithPwd" method="post"
			action="${sessionScope.path}/httppost">
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="100005">
			<input type="hidden" name="method" value="queryCardWithPwd">
			<table>
				<tr>
					<td><font color="red" size="5">有密卡信息查询接口</font></td>
				</tr>
				<tr>
					<td>
						AGENTCODE：
