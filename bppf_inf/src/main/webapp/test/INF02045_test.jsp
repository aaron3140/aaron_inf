...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02045.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02045">
			<input type="hidden" name="method" value="inf02045">
			<table>
				<tr>
					<td><font color="red" size="5">理财开户接口</font></td>
				</tr>
