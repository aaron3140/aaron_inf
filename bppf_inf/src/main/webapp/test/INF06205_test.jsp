...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF06205.txt");
...
<html>
	...
	<body onload="">
		<form name="paymentInfo" method="post" id="paymentInfo" 
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF06205">
			<input type="hidden" name="method" value="inf06205">
			<table>
				<tr>
					<td><font color="red" size="5" id="descName">[东莞公交]充值接口</font></td>
				</tr>
				...
				<tr>
					<td>
						...
						<select name="OPERATIONTYPE" id="OPERATIONTYPE" >
							...
							<option value="REG">充值</option>
							<option value="RGR">充值冲正</option>
						</select>（不送默认为充值）
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<span style="color:red" >*</span>交易前钱包剩余额度：
				...
				<tr>
					<td>
						<span style="color:red" >*</span>实收金额：
				...
				<tr>
					<td>
						<span style="color:red" >*</span>工作密钥授权流水号：
				...
				<tr>
					<td>
						<span style="color:red" >*</span>POS终端上笔充值流水号：
						<input name="LASTPOSSVSEQ" type="text" size="64" maxlength="64"
							value="${map.LASTPOSSVSEQ}">
					</td>
				</tr>
				<tr>
					<td>
