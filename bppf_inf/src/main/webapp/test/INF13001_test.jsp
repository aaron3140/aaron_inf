...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF13001.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF13001">
			<input type="hidden" name="method" value="inf13001">
			<table>
				<tr>
					<td><font color="red" size="5">交费易查询资产接口</font></td>
				</tr>
