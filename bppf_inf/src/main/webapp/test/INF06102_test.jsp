...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF06102.txt");
...
<html>
	...
	<body onload="onlaod()">
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF06102">
			<input type="hidden" name="method" value="inf06102">
			<table>
				<tr>
					<td><font color="red" size="5">水电煤账单缴费接口 </font></td>
				</tr>
	...
	<tr>
				...
				<tr>
					<td>
						<span style="color:red" type="BT001">*</span>销账单号类型：
							<select name="CASHTYPE" id="cashType">
							<option value="0" selected="selected">条码</option>
							<option value="1">缴费单号</option>
						</select>
					</td>
				</tr>
				<tr id="cashOrder">
					<td>
						账期：
						<input name="CASHORDER"  type="text" size="8" maxlength="8"
							value="${map.CASHORDER}">
					</td>
				</tr>
				<tr>
					<td>
						<span style="color:red" type="BT001">*</span>销帐单号：
						<input name="CASHNUMBER"  type="text" size="15" maxlength="64"
							value="${map.CASHNUMBER}">
					</td>
				</tr>
