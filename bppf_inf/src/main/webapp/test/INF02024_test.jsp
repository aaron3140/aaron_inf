...
<html>
	...
	<body onload="">
		<form name="paymentInfo" method="post" id="paymentInfo" 
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02024">
			<input type="hidden" name="method" value="inf02024">
			<table>
				<tr>
					<td><font color="red" size="5">账户绑卡验证接口 </font></td>
				</tr>
				...
				<tr>
					<td>
						验证类型：
							...
							<option value="000" selected="selected">无需验证</option>
							<option value="001">短信验证</option>
...
<%--					<td>
						...
						<input name="PAYPASSWORD" type="text" size="20" maxlength="32"
							value="${map.PAYPASSWORD}">
					</td>
				</tr>--%>
				<tr>
					<td>
						<span style="color:red" type="BT001">*</span>开户银行编码：
				...
				<tr>
					<td>
						<span style="color:red" type="BT001">*</span>开户行名称：
				...
				<tr>
					<td>
						<span style="color:red" type="BT001">*</span>开户姓名：
				...
				<tr>
					<td>
						<span style="color:red" type="BT001">*</span>身份证号：
