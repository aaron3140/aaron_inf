...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF12034.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF12034">
			<input type="hidden" name="method" value="inf12034">
			<table>
				<tr>
					<td><font color="red" size="5">腾讯QQ发货纯接口</font></td>
				</tr>
