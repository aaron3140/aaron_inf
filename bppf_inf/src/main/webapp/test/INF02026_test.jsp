...
<%
	java.util.Map map = FileUtil.getPageparams("WEB_INF02026.txt");
	...
	<body>
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16"
				value="INF02026">
			<input type="hidden" name="method" value="inf02026">
			<table>
				<tr>
					<td>
						<font color="red" size="5">广州后付费交易接口</font>
					</td>
				</tr>
				<tr>
					<td height="50">
				...
				<tr>
					<td>
						客户名：
						<input name="USERNAME" type="text" size="32" maxlength="32"
							value="${map.USERNAME}">
