...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02009.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02009">
			<input type="hidden" name="method" value="inf02009">
			<table>
				<tr>
					<td><font color="red" size="5">快捷交易设置接口</font></td>
				</tr>
				...
				<tr>
					<td>
						<span style="color:red">*</span>订单号:
							<input name="ORDERNO" type="text" size="25" maxlength="25" id="custCodeValId"
							value="${map.ORDERNO}">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						...
						<input name="PAYPASSWORD" type="text" size="32" maxlength="32"
							value="${map.PAYPASSWORD}"><span style="color:red"></span>
					</td>
				</tr>
				<tr>
					<td>
						单笔限额：
						<input name="PERAMOUNT" type="text" size="12" maxlength="12"
							value="${map.PERAMOUNT}"><span style="color:red"></span>
					</td>
				</tr>
				<tr>
					<td>
						累积限额：
						<input name="ALLAMOUNT" type="text" size="12" maxlength="12"
							value="${map.ALLAMOUNT}">
					</td>
				</tr>
				<tr>
