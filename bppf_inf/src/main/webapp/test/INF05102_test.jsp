...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF05102.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF05102">
			<input type="hidden" name="method" value="inf05102">
			<table>
				<tr>
					<td><font color="red" size="5">验证实时代收付接口</font></td>
				</tr>
