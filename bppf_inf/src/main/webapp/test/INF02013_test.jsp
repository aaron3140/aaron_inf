...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02013.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02013">
			<input type="hidden" name="method" value="inf02013">
			<table>
				<tr>
					<td><font color="red" size="5">快捷交易查询接口</font></td>
				</tr>
