...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF12036.txt");
...
<html>
	...
	<body onload="">
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF12036">
			<input type="hidden" name="method" value="inf12036">
			<table>
				<tr>
					<td><font color="red" size="5">火车票余座查询接口 </font></td>
				</tr>
				...
				<tr>
					<td>
						...
						<input name="QUERYID" type="text" size="15" maxlength="500"
							value="${map.QUERYID}">
					</td>
				</tr>
				<tr>
					<td>
						<span style="color:red">*</span>列车ID:
						<input name="TRAINID" type="text" size="15" maxlength="500"
							value="${map.TRAINID}">
					</td>
				</tr>
				<tr>
