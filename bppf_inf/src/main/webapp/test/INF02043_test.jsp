...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02043.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02043">
			<input type="hidden" name="method" value="inf02043">
			<table>
				<tr>
					<td><font color="red" size="5">消息详情查询接口</font></td>
				</tr>
			...
			<tr><td height="50">请求参数：</td></tr>
				...
				<tr>
					<td>
						<span class="fancy">*</span>信息标识：
						<input name="ISSUEID" type="text" size="15" maxlength="15"  required=required
							value="${map.ISSUEID}">
					</td>
				</tr>
		<tr>
