...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02021.txt");
...
function onlaod(){
	...
	<body onload="onlaod()">
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02021">
			<input type="hidden" name="method" value="inf02021">
			<table>
				<tr>
				...
				<tr>
					<td>
						<span style="color:red"></span>系统参考号:
							<input name="SYSTEMNO" type="text" size="12" maxlength="15" id="staffCode"
							value="${map.SYSTEMNO}">
					</td>
				</tr>
				<tr>
