...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02050">
			<input type="hidden" name="method" value="inf02050">
			<table>
				<tr>
					<td><font color="red" size="5">理财余额查询接口</font></td>
				</tr>
