...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF06207.txt");
...
<html>
	...
	<body onload="">
		<form name="paymentInfo" method="post" id="paymentInfo" 
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF06207">
			<input type="hidden" name="method" value="inf06207">
			<table>
				<tr>
					<td><font color="red" size="5" id="descName">[东莞公交]充值冲正接口</font></td>
				</tr>
