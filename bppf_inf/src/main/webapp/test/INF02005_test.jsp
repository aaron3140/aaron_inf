...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02005.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02005">
			<input type="hidden" name="method" value="transAcctList">
			<table>
				<tr>
					<td><font color="red" size="5">转账收款名单查询接口</font></td>
				</tr>
