...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF05105.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF05105">
			<input type="hidden" name="method" value="inf05105">
			<table>
				<tr>
					<td><font color="red" size="5">分账方案查询接口</font></td>
				</tr>
