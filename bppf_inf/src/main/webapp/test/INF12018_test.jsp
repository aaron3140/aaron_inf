...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF12018.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF12018">
			<input type="hidden" name="method" value="inf12018">
			<table>
				<tr>
