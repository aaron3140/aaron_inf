...
<%
	java.util.Map map=FileUtil.getPageparams("WEB_INF02047.txt");
...
<html>
	...
	<body>
		...
		<form name="paymentInfo" method="post"
			...
			<input name="WEBSVRCODE" type="hidden" size="16" maxlength="16" value="INF02047">
			<input type="hidden" name="method" value="inf02047">
			<table>
				<tr>
					<td><font color="red" size="5">理财申购支付接口</font></td>
				</tr>
			...
			<tr><td height="50">请求参数：</td></tr>
				...
				<tr>
					<td>
						<span style="color:red">*</span>业务订单号：
							<input name="BUSINESSORDERNO" type="text" size="15" maxlength="20" id="businessOrderNoValId"
							value="${map.BUSINESSORDERNO}">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<span style="color:red">*</span>资金源类型：
						<select name="FUNDSOURCETYPE">
